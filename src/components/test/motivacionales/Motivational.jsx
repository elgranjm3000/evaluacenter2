  ...
  return (
    <>
      ...
      <Container maxWidth="sm">
        ...
        <Menu handleLogout={handleLogout} titleFist={t('motivational')} />
          ...
          <Box sx={{ width: '100%' }}>
            ...
            <div>
              {activeStep === steps.length ? (
                <DialogToolbar titleDialog={t("motivationalPass.dialogTitle")} bodyDialog={t("motivationalPass.dialogBody")} />
              ) : (
                <div>
